...
print(logistic.predict([feature_engineer(231), feature_engineer(232), feature_engineer(101)]))

# def model_process(feature_vec):
#     return logistic.predict([feature_engineer(231)])
